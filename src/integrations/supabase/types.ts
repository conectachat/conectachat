  ...
  public: {
    Tables: {
      channels: {
        ...
        Relationships: [
          {
            foreignKeyName: "channels_crm_funnel_id_fkey"
      ...
      crm_cards: {
        Row: {
          ...
          position: number
          stage_id: string
          status: Database["public"]["Enums"]["crm_card_status"]
          title: string | null
          updated_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "crm_cards_assigned_user_id_fkey"
            columns: ["assigned_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "crm_cards_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "crm_cards_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "conversations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "crm_cards_funnel_id_fkey"
            columns: ["funnel_id"]
            isOneToOne: false
            referencedRelation: "crm_funnels"
            referencedColumns: ["id"]
      ...
      crm_funnels: {
        ...
        Relationships: [
          {
            foreignKeyName: "crm_funnels_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
