...
function CampanhasLayout() {
  // Campanhas (disparo em massa) é restrito ao proprietário e administradores.
    ...
    return (
      <div className="flex h-full flex-col items-center justify-center gap-3 p-6 text-center">
        ...
        <p className="max-w-sm text-sm text-muted-foreground">
          As Campanhas (disparo em massa) são exclusivas do proprietário e dos administradores da empresa.
        </p>
      </div>
    );
  }
